...
public:
    ...
    explicit ViewControl(const Eigen::Matrix3d& intrins, const int vertical_views,
                         const int horizontal_views, const double distance);
    std::vector<Eigen::Matrix4d> getExtrinsics() const { return extrinsics_; };
