...
int main( int argc, char** argv )
{
    ...
    std::string vert_shader = "/home/ipa-mah/1_projects/perception_utils/shaders/rendermode.vert";
    std::string frag_shader = "/home/ipa-mah/1_projects/perception_utils/shaders/rendermode.frag";
